...
namespace GPSImageTag.Core.Helpers
{
    ...
    public static class Settings
    {
        ...
        static readonly string SasTokenDefault = string.Empty;
        ...
        public static string SasToken
        {
            get
            {
                return AppSettings.GetValueOrDefault<string>(SasTokenKey, AuthTokenDefault);
            }
            set
            {
                AppSettings.AddOrUpdateValue<string>(SasTokenKey, value);
            }
        }
    }
}