...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "GPSImageTag.DroidNative.dll" comes first in this list. */
		"GPSImageTag.DroidNative.dll",
		...
		"GPSImageTag.Core.dll",
		"GPSImageTag.Droid.dll",
		"GPSImageTag.ViewModels.dll",
